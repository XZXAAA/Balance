...
#define OLED_RS PBout(9)   //对应OLED的DC   //9
...
//使用4线串行接口时使用 
#define OLED_SCLK PCout(15)   //C15
#define OLED_SDIN PCout(14)	  //C14
...
void Write_Chinese(u8 x,u8 y, const unsigned char (*string)[32], u8 mode, u8 number);     //16*16  高位在上
#endif  
